  ...
  const fetchStockData = async () => {
    try {
      ...
      const stockResponse = await fetch(
        '/api/stock-data?symbols=AAPL,GOOGL,MSFT,TSLA,NVDA,AMZN,META,BRK-B,JPM,V'
      );
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`text-sm font-medium ${getChangeColor(index.change)}`}
                    >
                      {getChangeIcon(index.change)}{' '}
                      {formatNumber(index.change, 2)} (
                      {formatNumber(index.changePercent, 2)}%)
                    </span>
                  </div>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`text-sm font-medium ${getChangeColor(stock.change)}`}
                    >
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        {stock.dividendYield
                          ? `${formatNumber(stock.dividendYield, 2)}%`
                          : 'N/A'}
                      </span>
                    </div>
                    <div className="flex justify-between">
